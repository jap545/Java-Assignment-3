package com.example.comp1011assignment3_200528741;
...
public class MainActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        confirmClearContentsDialog.setNegativeButton("No", (dialog, which) -> Toast.makeText(MainActivity.this,"Good decision. (No clicked)",Toast.LENGTH_SHORT).show());
